...
public class CryptUtil {
    ...
    protected Logger log = LoggerFactory.getLogger(CryptUtil.class);
...
//            fos.close();
    ...
    private SecretKeyFactory getSecretKeyFactory() throws Exception{
        ...
        try {
            secretKeyFactory = secretKeyFactoryThreadLocal.get();
            ...
            if(secretKeyFactoryThreadLocal!=null){
                secretKeyFactoryThreadLocal.remove();
            }
        }
