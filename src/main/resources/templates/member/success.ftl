...
<div class="reg-box m30 mt10" id="verifyCheck">
    <div class="part3 tc h300" style=" margin-top:80px;">
        <div>
        ...
        <#--<div class=" mt20">-->
            <#--<button class="btn btn-info mr15">查看订单信息</button>-->
            <#--<button class="btn btn-success">前往课程学习</button>-->
        <#--</div>-->
    </div>
</div>

<#include "../common/bottom.ftl">
<script data-main="${ctx}/js/abc/member/success" src="${ctx}/js/require.js"></script>
</body>
</html>
</@compress>