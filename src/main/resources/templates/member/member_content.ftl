        ...
        <div class="left">
                ...
                <div class="cent">
                    ...
                    <div class="vip">
                        ...
                        <#if (user.vipLevel)?? && user.vipLevel == "VIP0">
                              <a data-url="${ctx}/member/order_member.html" href="javascript:void (0)">开通会员</a>
                        </#if>
                    </div>
                </div>
            </div>
            <div class="bottom">
                <ul id="hy_left">
                    ...
                    <li name="member_integral_uc.html">
                        <a  href="javascript:void (0)">
                            <i class="iconfont" style="margin-left: 0px">&#xe7e6;</i>
                        </a>
                        <p>积分兑换</p>
