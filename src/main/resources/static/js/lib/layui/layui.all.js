...
!function (e) {
    ...
    n.prototype.cache = o, n.prototype.define = function (e, t) {
        ...
        return layui.link(o.dir + "lib/layui/css/" + e, t, n)
...
!function () {
    ...
    w.prototype = [], w.prototype.constructor = w, T.extend = function () {
        ...
        }), m = n.elemHeader[t], u = T(m[2]).find("span"), h = n.elemCont[t || 0], y = T(h).find("." + c)[0], f = "cn" === a.lang, D = f ? "年" : "", w = n.listYM[t] || {}, C = ["hours", "minutes", "seconds"], x = ["startTime", "endTime"][t];
...
layui.define("layer", function (e) {
    ...
    }, l = "upload", r = "layui-upload-file", u = "layui-upload-form", c = "layui-upload-iframe", s = "layui-upload-choose", f = function (e) {
        var t = this;
    ...
    f.prototype.config = {
        ...
        var e = this, t = e.config, o = e.elemFile = i(['<input class="' + r + '" type="file" name="' + t.field + '"', t.multiple ? " multiple" : "", ">"].join("")), a = t.elem.next();
        ...
        var e = this, t = e.config, n = i('<iframe id="' + c + '" class="' + c + '" name="' + c + '" frameborder="0"></iframe>'), o = i(['<form target="' + c + '" class="' + u + '" method="' + t.method, '" key="set-mine" enctype="multipart/form-data" action="' + t.url + '">', "</form>"].join(""));
        ...
        var e = this, t = e.config, o = function (i) {
            ...
            var o = e.elemFile, a = i.length > 1 ? i.length + "个文件" : (i[0] || {}).name || o[0].value.match(/[^\/\\]+\..+/g) || [] || "";
...
layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    j.prototype.config = {limit: 30, loading: !0}, j.prototype.render = function () {
        ...
        var e, a = this, d = a.config, o = t("body"), u = {}, f = a.layHeader.find("th"), h = ".layui-table-cell", y = d.elem.attr("lay-filter");
