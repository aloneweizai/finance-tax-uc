define(function (){
	...
	var jiangPinResult = function(){
		...
		str +='<img class="gongxi" src="' +uri1 +  '/images/gx.png" alt="恭喜你" title="恭喜">';
		str +='<p>获得500元现金</p>';
		str +='<img class="imgJiangPin" src="' +uri1 +  '/images/jiangpin.png" alt="奖品" title="奖品">';
		str +='<a href="#"><input class="btn_Get" value="领取奖品" type="button"></a>';
		str +='<img class="colseJiangPin" src="' +uri1 +  '/images/close.png" alt="关闭" title="关闭">';
		str +='</div>';
	...
	var alertLogin = function(){
		...
		str += '<img class="colseLogin" src="' +uri1 +  '/images/close.png" alt="关闭">';
	...
	var clickJinDanView = function(){
		...
		str +='<img class="caiDai" src="' +uri1 +  '/images/caidai.png" alt="彩带">';
		str +='<img class="imgDan" src="' +uri1 +  '/images/egg.png" alt="砸蛋" title="砸蛋">';
		str +='<img class="imgChuiZi" src="' +uri1 +  '/images/chuizi.png">';
		str +='</div>';
